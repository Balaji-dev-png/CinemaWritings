...
export function LinkCard({ element, onMove, onResize, onUpdate, onRemove, onConnectClick, connectMode, isConnectSource, getZoom, getPan, isSelected, onSelect }: Props) {
